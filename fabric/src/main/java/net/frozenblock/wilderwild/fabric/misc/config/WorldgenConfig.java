...
public final class WorldgenConfig implements ConfigData {
    ...
    static void setupEntries(ConfigCategory category, ConfigEntryBuilder entryBuilder) {
        ...
        category.setBackground(WilderWildFabric.id("textures/config/worldgen.png"));
        ...
        var biomePlacementCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("biome_placement"),
                false,
