...
import net.frozenblock.lib.fabric.config.FrozenConfigFabric;
import net.frozenblock.wilderwild.fabric.WilderWildFabric;

import static net.frozenblock.wilderwild.fabric.misc.config.WilderWildConfig.text;
import static net.frozenblock.wilderwild.fabric.misc.config.WilderWildConfig.tooltip;
...
public final class EntityConfig implements ConfigData {
    ...
    static void setupEntries(ConfigCategory category, ConfigEntryBuilder entryBuilder) {
        ...
        category.setBackground(WilderWildFabric.id("textures/config/entity.png"));
        ...
        var allayCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("allay"),
                false,
                tooltip("allay")

        );

        var fireflyCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("firefly"),
                false,
                tooltip("firefly")

        );

        var jellyfishCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("jellyfish"),
                false,
                tooltip("jellyfish")
        ...
        var wardenCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("warden"),
                false,
                tooltip("warden"),
