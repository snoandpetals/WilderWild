...
import net.frozenblock.wilderwild.fabric.tag.WilderItemTags;
...
public final class RegisterLootTables {
    ...
    public static void init() {
        WilderWildFabric.logWild("Registering Loot Table Modifications for", WilderWild.UNSTABLE_LOGGING);
