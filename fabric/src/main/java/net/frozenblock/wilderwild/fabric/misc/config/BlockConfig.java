...
public final class BlockConfig implements ConfigData {
    ...
    static void setupEntries(ConfigCategory category, ConfigEntryBuilder entryBuilder) {
        ...
        category.setBackground(WilderWildFabric.id("textures/config/block.png"));
        ...
        var displayLanternCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("display_lantern"),
                false,
                tooltip("display_lantern")

        );

        var stoneChestCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("stone_chest"),
                false,
                tooltip("stone_chest")

        );

        var termiteCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("termite"),
                false,
                tooltip("termite")
