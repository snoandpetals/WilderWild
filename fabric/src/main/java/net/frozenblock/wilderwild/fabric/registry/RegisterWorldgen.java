...
import net.frozenblock.wilderwild.fabric.world.feature.WilderPlacedFeatures;
import net.frozenblock.wilderwild.fabric.world.gen.SharedWorldgen;
import net.frozenblock.wilderwild.fabric.world.gen.noise.WilderNoise;
...
public final class RegisterWorldgen implements CommonEventEntrypoint {
    ...
    public static void registerWorldgen() {
        WilderWildFabric.logWild("Registering Biomes for", WilderWild.UNSTABLE_LOGGING);
    ...
    public static void modifyOverworldRules(SurfaceRuleContext.@NotNull Overworld context) {
 ...
 */
        WilderWildFabric.log("Wilder Wild's Overworld Surface Rules have been added!", WilderWild.UNSTABLE_LOGGING);
    }

    // SPONGEBOB
    public static void modifyNetherRules(SurfaceRuleContext.@NotNull Nether context) {
        /*context.materialRules().clear();
        context.materialRules().add(0, FrozenSurfaceRules.makeStateRule(Blocks.SPONGE));*/
        WilderWildFabric.log("SPONGEBOB", WilderWild.UNSTABLE_LOGGING);
    }

    private static ResourceKey<Biome> register(String name) {
        return ResourceKey.create(Registry.BIOME_REGISTRY, WilderWildFabric.id(name));
    }
    ...
    public static void addCypressWetlandsMobs(MobSpawnSettings.Builder builder) {
        ...
        builder.addSpawn(WilderWildFabric.FIREFLIES, new MobSpawnSettings.SpawnerData(RegisterEntities.FIREFLY, 1, 2, 6));
    }
