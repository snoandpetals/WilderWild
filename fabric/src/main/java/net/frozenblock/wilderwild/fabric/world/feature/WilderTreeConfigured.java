...
import net.frozenblock.wilderwild.fabric.block.BaobabNutBlock;
import net.frozenblock.wilderwild.fabric.registry.RegisterBlocks;
import net.frozenblock.wilderwild.fabric.world.gen.treedecorators.HeightBasedVineTrunkDecorator;
import net.frozenblock.wilderwild.fabric.world.gen.treedecorators.ShelfFungusTreeDecorator;
...
public final class WilderTreeConfigured {
    ...
    public static void registerTreeConfigured() {
        WilderWildFabric.logWild("Registering WilderTreeConfigured for", true);
    }
}