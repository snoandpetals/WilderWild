...
public final class ItemConfig implements ConfigData {
    ...
    static void setupEntries(ConfigCategory category, ConfigEntryBuilder entryBuilder) {
        ...
        category.setBackground(WilderWildFabric.id("textures/config/item.png"));
        ...
        var ancientHornCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("ancient_horn"),
                false,
                tooltip("ancient_horn"),
                shattersGlass, summonsWarden
        );

        var copperHornCategory = FrozenConfigFabric.createSubCategory(entryBuilder, category, text("copper_horn"),
                false,
                tooltip("copper_horn")
