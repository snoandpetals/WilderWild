...
public class DisplayLanternBlockEntityRenderer<T extends DisplayLanternBlockEntity> implements BlockEntityRenderer<T> {
    ...
    private static final ResourceLocation TEXTURE = WilderWildFabric.id("textures/entity/firefly/firefly_off.png");
    private static final RenderType LAYER = RenderType.entityCutout(TEXTURE);

    private static final RenderType NECTAR_LAYER = RenderType.entityCutout(WilderWildFabric.id("textures/entity/firefly/nectar.png"));
    private static final RenderType NECTAR_FLAP_LAYER = RenderType.entityCutout(WilderWildFabric.id("textures/entity/firefly/nectar_wings_down.png"));
    private static final RenderType NECTAR_OVERLAY = RenderType.entityTranslucentEmissive(WilderWildFabric.id("textures/entity/firefly/nectar_overlay.png"), true);

    public DisplayLanternBlockEntityRenderer(Context ctx) {
        ModelPart root = ctx.bakeLayer(WilderWildClientFabric.DISPLAY_LANTERN);
