...
public class AncientHornProjectileRenderer<T extends AncientHornProjectile> extends EntityRenderer<T> {
    public static final ResourceLocation TEXTURE = WilderWildFabric.id("textures/entity/ancient_horn_projectile.png");
    ...
    public AncientHornProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new AncientHornProjectileModel(context.bakeLayer(WilderWildClientFabric.ANCIENT_HORN_PROJECTILE_LAYER));
    }
