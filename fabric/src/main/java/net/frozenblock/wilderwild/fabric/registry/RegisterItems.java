...
import net.frozenblock.wilderwild.fabric.item.AncientHorn;
import net.frozenblock.wilderwild.fabric.item.CopperHorn;
import net.frozenblock.wilderwild.fabric.item.FireflyBottle;
import net.frozenblock.wilderwild.fabric.item.MilkweedPod;
import net.frozenblock.wilderwild.fabric.misc.FireflyColor;
import net.frozenblock.wilderwild.fabric.misc.WilderBoats;
import net.frozenblock.wilderwild.fabric.tag.WilderInstrumentTags;
...
public final class RegisterItems {
    ...
    public static final ResourceKey<Instrument> ANCIENT_HORN_INSTRUMENT = ResourceKey.create(Registry.INSTRUMENT_REGISTRY, WilderWildFabric.id("ancient_horn"));
    ...
    public static final ResourceKey<Instrument> SAX_COPPER_HORN = ResourceKey.create(Registry.INSTRUMENT_REGISTRY, WilderWildFabric.id("sax_copper_horn"));
    public static final ResourceKey<Instrument> TUBA_COPPER_HORN = ResourceKey.create(Registry.INSTRUMENT_REGISTRY, WilderWildFabric.id("tuba_copper_horn"));
    public static final ResourceKey<Instrument> FLUTE_COPPER_HORN = ResourceKey.create(Registry.INSTRUMENT_REGISTRY, WilderWildFabric.id("flute_copper_horn"));
    public static final ResourceKey<Instrument> OBOE_COPPER_HORN = ResourceKey.create(Registry.INSTRUMENT_REGISTRY, WilderWildFabric.id("oboe_copper_horn"));
    public static final ResourceKey<Instrument> CLARINET_COPPER_HORN = ResourceKey.create(Registry.INSTRUMENT_REGISTRY, WilderWildFabric.id("clarinet_copper_horn"));
    public static final ResourceKey<Instrument> TRUMPET_COPPER_HORN = ResourceKey.create(Registry.INSTRUMENT_REGISTRY, WilderWildFabric.id("trumpet_copper_horn"));
    public static final ResourceKey<Instrument> TROMBONE_COPPER_HORN = ResourceKey.create(Registry.INSTRUMENT_REGISTRY, WilderWildFabric.id("trombone_copper_horn"));

    public static void registerItems() {
        WilderWildFabric.logWild("Registering Items for", WilderWild.UNSTABLE_LOGGING);
        Registry.register(Registry.ITEM, WilderWildFabric.id("baobab_boat"), BAOBAB_BOAT_ITEM);
        Registry.register(Registry.ITEM, WilderWildFabric.id("baobab_chest_boat"), BAOBAB_CHEST_BOAT_ITEM);
        Registry.register(Registry.ITEM, WilderWildFabric.id("baobab_sign"), BAOBAB_SIGN);
        Registry.register(Registry.ITEM, WilderWildFabric.id("cypress_boat"), CYPRESS_BOAT_ITEM);
        Registry.register(Registry.ITEM, WilderWildFabric.id("cypress_chest_boat"), CYPRESS_CHEST_BOAT_ITEM);
        Registry.register(Registry.ITEM, WilderWildFabric.id("cypress_sign"), CYPRESS_SIGN);
        Registry.register(Registry.ITEM, WilderWildFabric.id("ancient_horn"), ANCIENT_HORN);
        Registry.register(Registry.ITEM, WilderWildFabric.id("copper_horn"), COPPER_HORN);
        Registry.register(Registry.ITEM, WilderWildFabric.id("milkweed_pod"), MILKWEED_POD);
        Registry.register(Registry.ITEM, WilderWildFabric.id("music_disc_beneath"), MUSIC_DISC_BENEATH);
        Registry.register(Registry.ITEM, WilderWildFabric.id("music_disc_goathorn_symphony"), MUSIC_DISC_GOAT_HORN_SYMPHONY);
        Registry.register(Registry.ITEM, WilderWildFabric.id("music_disc_back"), MUSIC_DISC_BACK);
        Registry.register(Registry.ITEM, WilderWildFabric.id("firefly_spawn_egg"), FIREFLY_SPAWN_EGG);
        Registry.register(Registry.ITEM, WilderWildFabric.id("jellyfish_spawn_egg"), JELLYFISH_SPAWN_EGG);
        Registry.register(Registry.ITEM, WilderWildFabric.id("jellyfish_bucket"), JELLYFISH_BUCKET);
        ...
        Registry.register(Registry.ITEM, WilderWildFabric.id("baobab_nut"), BAOBAB_NUT);
        ...
        Registry.register(Registry.ITEM, WilderWildFabric.id("firefly_bottle"), FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("magenta_firefly_bottle"), MAGENTA_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("purple_firefly_bottle"), PURPLE_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("blue_firefly_bottle"), BLUE_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("black_firefly_bottle"), BLACK_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("red_firefly_bottle"), RED_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("green_firefly_bottle"), GREEN_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("brown_firefly_bottle"), BROWN_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("cyan_firefly_bottle"), CYAN_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("light_gray_firefly_bottle"), LIGHT_GRAY_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("gray_firefly_bottle"), GRAY_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("pink_firefly_bottle"), PINK_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("lime_firefly_bottle"), LIME_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("yellow_firefly_bottle"), YELLOW_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("light_blue_firefly_bottle"), LIGHT_BLUE_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("orange_firefly_bottle"), ORANGE_FIREFLY_BOTTLE);
        Registry.register(Registry.ITEM, WilderWildFabric.id("white_firefly_bottle"), WHITE_FIREFLY_BOTTLE);

        Registry.register(Registry.ITEM, WilderWildFabric.id("pollen"), POLLEN);

        Registry.register(Registry.ITEM, WilderWildFabric.id("ancient_horn_fragment"), ANCIENT_HORN_FRAGMENT);
