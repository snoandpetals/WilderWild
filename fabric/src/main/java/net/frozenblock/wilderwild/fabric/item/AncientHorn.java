...
public class AncientHorn extends InstrumentItem {
    ...
    public InteractionResultHolder<ItemStack> use(@NotNull Level level, @NotNull Player user, @NotNull InteractionHand hand) {
        WilderWildFabric.log(user, "Used Ancient Horn", WilderWild.DEV_LOGGING);
        ...
        if (optional.isPresent()) {
            ...
            if (level instanceof ServerLevel server) {
                ...
                FrozenSoundPackets.createMovingRestrictionLoopingSound(server, projectileEntity, RegisterSounds.ENTITY_ANCIENT_HORN_PROJECTILE_LOOP, SoundSource.NEUTRAL, 1.0F, 1.0F, WilderWildFabric.id("default"));
