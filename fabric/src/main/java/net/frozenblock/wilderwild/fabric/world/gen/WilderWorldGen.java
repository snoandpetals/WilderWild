...
import net.frozenblock.wilderwild.fabric.world.gen.treedecorators.WilderTreeDecorators;
...
public final class WilderWorldGen {
    ...
    private static void replaceFeatures() {
        BiomeModifications.create(WilderWildFabric.id("replace_forest_grass"))
        ...
        BiomeModifications.create(WilderWildFabric.id("replace_birch_trees"))
                .add(ModificationPhase.REPLACEMENTS,
        ...
        BiomeModifications.create(WilderWildFabric.id("replace_plains_trees"))
                .add(ModificationPhase.REPLACEMENTS,
        ...
        BiomeModifications.create(WilderWildFabric.id("replace_swamp_trees"))
                .add(ModificationPhase.REPLACEMENTS,
