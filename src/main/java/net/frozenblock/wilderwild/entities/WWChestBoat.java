...
public class WWChestBoat extends WWBoat implements HasCustomInventoryScreen, ContainerEntity {
    private NonNullList<ItemStack> inventory = NonNullList.withSize(27, ItemStack.EMPTY);
    @Nullable
    private ResourceLocation lootTableId;
    private long lootTableSeed;

    public WWChestBoat(EntityType<? extends WWBoat> entityType, Level world) {
        super(entityType, world);
    }

    public WWChestBoat(Level world, double d, double e, double f) {
        this(WWEntityTypes.CHEST_BOAT.get(), world);
        this.setPos(d, e, f);
        this.xo = d;
        this.yo = e;
        this.zo = f;
    ...
    public Item getDropItem() {
        return this.getWWBoatType() == WWBoatType.BAOBAB ? WWItems.BAOBAB_CHEST_BOAT_ITEM.get() : WWItems.CYPRESS_CHEST_BOAT_ITEM.get();
    }
