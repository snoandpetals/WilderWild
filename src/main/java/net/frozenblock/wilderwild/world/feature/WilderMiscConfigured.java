...
public class WilderMiscConfigured {
    ...
    public static final Holder<ConfiguredFeature<SimpleRandomFeatureConfiguration, ?>> BLANK_SHUT_UP = WilderConfiguredFeatures.register("blank_shut_up", Feature.SIMPLE_RANDOM_SELECTOR, new SimpleRandomFeatureConfiguration(HolderSet.direct(
            PlacementUtils.inlinePlaced(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.WATER.defaultBlockState())))))
    );
    ...
    public static final Holder<ConfiguredFeature<PillarFeatureConfig, ?>> UPWARDS_MESOGLEA_PILLAR = WilderConfiguredFeatures.register("blue_mesoglea_pillar", WWFeatures.UPWARDS_PILLAR_FEATURE.get(), new PillarFeatureConfig(WWBlocks.BLUE_PEARLESCENT_MESOGLEA.get().defaultBlockState().setValue(BlockStateProperties.WATERLOGGED, true), UniformInt.of(4, 12), HolderSet.direct(WWBlocks.BLUE_PEARLESCENT_MESOGLEA.get().builtInRegistryHolder(), WWBlocks.PURPLE_PEARLESCENT_MESOGLEA.get().builtInRegistryHolder(), Blocks.WATER.builtInRegistryHolder())));
    public static final Holder<ConfiguredFeature<PillarFeatureConfig, ?>> PURPLE_MESOGLEA_PILLAR = WilderConfiguredFeatures.register("purple_mesoglea_pillar", WWFeatures.UPWARDS_PILLAR_FEATURE.get(), new PillarFeatureConfig(WWBlocks.PURPLE_PEARLESCENT_MESOGLEA.get().defaultBlockState().setValue(BlockStateProperties.WATERLOGGED, true), UniformInt.of(4, 12), HolderSet.direct(WWBlocks.BLUE_PEARLESCENT_MESOGLEA.get().builtInRegistryHolder(), WWBlocks.PURPLE_PEARLESCENT_MESOGLEA.get().builtInRegistryHolder(), Blocks.WATER.builtInRegistryHolder())));
    public static final Holder<ConfiguredFeature<PillarFeatureConfig, ?>> DOWNWARDS_MESOGLEA_PILLAR = WilderConfiguredFeatures.register("downwards_blue_mesoglea_pillar", WWFeatures.DOWNWARDS_PILLAR_FEATURE.get(), new PillarFeatureConfig(WWBlocks.BLUE_PEARLESCENT_MESOGLEA.get().defaultBlockState().setValue(BlockStateProperties.WATERLOGGED, true), UniformInt.of(3, 10), HolderSet.direct(WWBlocks.BLUE_PEARLESCENT_MESOGLEA.get().builtInRegistryHolder(), WWBlocks.PURPLE_PEARLESCENT_MESOGLEA.get().builtInRegistryHolder(), Blocks.WATER.builtInRegistryHolder())));
    public static final Holder<ConfiguredFeature<PillarFeatureConfig, ?>> DOWNWARDS_PURPLE_MESOGLEA_PILLAR = WilderConfiguredFeatures.register("downwards_purple_mesoglea_pillar", WWFeatures.DOWNWARDS_PILLAR_FEATURE.get(), new PillarFeatureConfig(WWBlocks.PURPLE_PEARLESCENT_MESOGLEA.get().defaultBlockState().setValue(BlockStateProperties.WATERLOGGED, true), UniformInt.of(3, 10), HolderSet.direct(WWBlocks.BLUE_PEARLESCENT_MESOGLEA.get().builtInRegistryHolder(), WWBlocks.PURPLE_PEARLESCENT_MESOGLEA.get().builtInRegistryHolder(), Blocks.WATER.builtInRegistryHolder())));
