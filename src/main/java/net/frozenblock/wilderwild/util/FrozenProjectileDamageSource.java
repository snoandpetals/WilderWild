...
public class FrozenProjectileDamageSource extends IndirectEntityDamageSource {
    ...
    public Component getLocalizedDeathMessage(LivingEntity entity) {
        ...
        return !itemStack.isEmpty() && itemStack.hasCustomHoverName() ? Component.translatable(string2, new Object[]{entity.getDisplayName(), text, itemStack.getDisplayName()}) : Component.translatable(string, new Object[]{entity.getDisplayName(), text});
    }
}
